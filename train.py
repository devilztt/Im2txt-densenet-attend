...
from im2txt import show_attend_and_tell
...
tf.flags.DEFINE_integer("number_of_steps", 750, "Number of training steps.")
...
def main(unused_argv):
  ...
  with g.as_default():
    # Build the model.
    model = show_attend_and_tell.ShowAndTellModel(
